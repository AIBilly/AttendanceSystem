...
public class myJsonRequest {
    ...
    static public void Login(JSONObject jsonBody, Cache cache, final volleyCallback callback){
        jsonPostRequest(Request.Method.POST, "http://35.225.173.253:8080/api/authenticate", jsonBody, cache, callback);
    }

    static public void signUp(JSONObject jsonBody, Cache cache, final volleyCallback callback){
        jsonPostRequest(Request.Method.POST, "http://35.225.173.253:8080/api/register", jsonBody, cache, callback);
    }

    static public void getUser(Cache cache, final volleyCallback callback){
        jsonGetRequest(Request.Method.GET, "http://35.225.173.253:8080/api/account", cache, callback);
    }

    static public void createTask(JSONObject jsonBody, Cache cache, final volleyCallback callback){
        jsonPostRequestWithHeaders(Request.Method.POST, "http://35.225.173.253:8080/api/tasks", jsonBody, cache, callback);
    }

    static public void getTask(Cache cache, final volleyArrayCallback callback){
        jsonMultiGetRequest(Request.Method.GET, "http://35.225.173.253:8080/api/tasks", cache, callback);
    }

    static public void updateTask(JSONObject jsonBody, Cache cache, final volleyCallback callback){
        jsonPostRequestWithHeaders(Request.Method.PUT, "http://35.225.173.253:8080/api/tasks", jsonBody, cache, callback);
    }
